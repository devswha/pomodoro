-- =====================================================================================
-- COMPLETE DATABASE SCHEMA FOR POMODORO TIMER v4.0.0
...
-- =====================================================================================
-- 6. MEETING PARTICIPANTS TABLE (COLLABORATION)
-- =====================================================================================
...
-- =====================================================================================
-- 7. AUTH SESSIONS TABLE (Optional - for custom auth tracking)
-- =====================================================================================
...
CREATE POLICY "Users can manage own sessions" ON public.auth_sessions
    FOR ALL USING (auth.uid() = user_id);
...
-- This will be populated by the application when users sign up
-- No sample data needed as users will create their own accounts
...
COMMENT ON SCHEMA public IS 'Pomodoro Timer v4.0.0 - Complete database schema with collaboration features';