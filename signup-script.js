class SignupFlow {
    ...
    attachEventListeners() {
        ...
        // Focus events
        [this.passwordInput, this.confirmPasswordInput, this.idInput].forEach(input => {
    ...
    getCurrentStepInput() {
        switch (this.currentStep) {
            case 1: return this.passwordInput;
            case 2: return this.confirmPasswordInput;
            case 3: return this.idInput;
            default: return this.passwordInput;
        }
    }
