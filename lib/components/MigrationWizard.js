  ...
  function WelcomeStep() {
    return (
      <StepContent>
        ...
        <StepDescription>
          This wizard will guide you through migrating your Pomodoro Timer data from localStorage to Supabase. 
  ...
  function HealthCheckStep() {
      ...
      return (
        <StepContent>
          <LoadingSpinner>
            ...
            <div>Scanning localStorage for Pomodoro Timer data...</div>
          </LoadingSpinner>
        </StepContent>
      )
    }
    ...
    return (
      <StepContent>
        ...
        <StepDescription>
          We've scanned your localStorage for Pomodoro Timer data. Here's what we found:
        </StepDescription>
        ...
        {healthCheckResults?.statistics.totalUsers === 0 && (
          <WarningBox>
            ...
            <div className="warning-text">
              We couldn't find any Pomodoro Timer data in your localStorage. 
    ...
    return (
      <StepContent>
        ...
        <StepDescription>
          ...
          the cloud-based version of the Pomodoro Timer.
        </StepDescription>
